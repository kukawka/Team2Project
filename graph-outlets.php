    ...
    <div class="row">
        <nav class="col-md-2 d-none d-sm-block bg-light sidebar">
            <ul class="nav nav-pills flex-column">
                <li class="nav-item">
                    <a class="nav-link" href="graph-overview.php">Overview | Total Sales<span
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="graph-outlets.php">Transactions Throughout a Day</a>
                </li>
            </ul>
        ...
        <main class="ml-sm-auto col-md-10 pt-3" role="main">
            <h1 id="overview">Transactions Throughout a Day | <?php echo $_SESSION['userOutletName'];?></h1>
